  ...
  return (
    <div className="overflow-hidden rounded-lg p-4 mob:p-2 laptop:p-4 first:ml-0">
      ...
      <div className="flex">
        ...
        {active === true ? (
          <div className="flex justify-center mt-[20px] mx-[1rem] w-[50px] h-[30px] bg-green-500 rounded-full">
            <h1 className="text-white m-1">Live</h1>
          </div>
        ) : (
          ""
        )}
        ...
        {techIcons?.map((icon, index) => (
          <>
            {icon ? (
              <img
                key={index}
                className="w-[35px] rounded-full p-1"
                src={icon.url}
              />
            ) : (
              ""
      ...
      <div>
        {repoURL ? (
          <button
            ...
            className="my-[1rem] mr-[1rem] p-[1rem] rounded-xl bg-gray-100 hover:bg-gray-200"
          >
            GitHub Repo
          </button>
        ) : (
          <button
            disabled
            onClick={() => window.open(repoURL)}
            className="my-[1rem] mr-[1rem] p-[1rem] rounded-xl bg-gray-100 hover:bg-gray-200 border-1"
          >
